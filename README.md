...
패킷 필터링의 대상 프로토콜은 IPv4 기반의 TCP, UDP 프로토콜이다.</br></br>

# 1. 주요기능
+ Rule의 개수는 10만개 이상을 지원 <br>
+ 일치하는 Rule이 있을 경우 S/DNAT(SNAT, DNAT), DROP, Accept 기능을 수행하고 패킷을 포워딩 <br><br>
...
# 참고
XFW 프로그램은 XDP 커널 모듈에서 세션을 저장하고 세션 정리는 응용프로그램에서 정리한다. (60초 경과 세션 대상) </br></br>
